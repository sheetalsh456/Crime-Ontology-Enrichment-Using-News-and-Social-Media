...
onto = get_ontology(base_irri+'social_onto.owl').load()
g = generate_graph(onto)
# graph_draw(g, vertex_text=g.vp.labels, vertex_fill_color=g.vp.colors, vertex_font_size=10, output_size=(1920,1080), vertex_text_position=0)
